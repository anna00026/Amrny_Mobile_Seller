...
class EmployeeEditPage extends StatefulWidget {
  int? employeeId;
  EmployeeEditPage({super.key, this.employeeId});
...
class _EmployeeEditPageState extends State<EmployeeEditPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CommonHelper().appbarCommon(employeeId != null ? 'Edit employee' : 'New employee', context, () {
        if (Provider.of<ProfileEditService>(context, listen: false).isloading ==
          ...
          OthersHelper().showToast(
              Provider.of<AppStringService>(context, listen: false)
                  .getString('Please wait while the employee is saving'),
              Colors.black);
        }
      }),
      body: Listener(
                                ...
                                builder: (context, profileProvider, child) =>
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: pickedImage == null
                                          ? profileProvider.employeeImage != null
